...
class Score extends React.Component {
  ...
  componentDidUpdate(prevProps, prevState) {
    ...
    if (Object.keys(prevProps.score.pageState).length && this.props.uri in prevProps.score.pageState && (prevProps.score.pageState[this.props.uri].currentPage !== this.props.score.pageState[this.props.uri].currentPage ||
    // on page flip...
