...
class Score extends React.Component {
  ...
  render() {
    ...
    if ("score" in this.props && this.props.uri in this.props.score.SVG && this.props.uri in this.props.score.pageState && "currentPage" in this.props.score.pageState[this.props.uri] && this.props.score.pageState[this.props.uri].currentPage in this.props.score.SVG[this.props.uri]) {
