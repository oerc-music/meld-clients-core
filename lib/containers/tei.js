...
class TEI extends Component {
  ...
  componentDidUpdate() {
    ...
    this.props.annotations.map(annotation => {
      ...
      if (pref.oa + "motivatedBy" in annotation && annotation[pref.oa + "motivatedBy"]["@id"] === pref.meldterm + "personInfo") {
        var myFrags = Array.isArray(annotation[pref.oa + "hasTarget"]) ? annotation[pref.oa + "hasTarget"] : [annotation[pref.oa + "hasTarget"]];
        this.handleMELDActions(annotation, myFrags);
      }
    });
    this.findOtherRefs();
      ...
      switch (idOrFirstId(annotation[pref.oa + "motivatedBy"])) {
        ...
        case pref.meldterm + "personInfo":
          ...
          if (annBody.definition) {
            ...
            var definition = {
              definition: annBody[pref.meldterm + "definition"] ? annBody[pref.meldterm + "definition"] : annBody[pref.meldterm + "hasDefinition"],
              head: annBody[pref.meldterm + "head"] ? annBody[pref.meldterm + "head"] : annBody[pref.meldterm + "hasHead"],
