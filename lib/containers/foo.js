...
const uri = "http://meld.linkedmusic.org/mei/test.mei"; // Which part of the Redux global state does our component want to receive as props?   
...
class Foo extends Component {
  ...
  render() {
    if (this.props.foo.data) {
      return /*#__PURE__*/React.createElement("div", null, this.props.foo.data);
    } else {
