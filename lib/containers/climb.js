    ...
    if (this.props.score.publishedScores) {
      if (this.props.score.triggerNextSession) {
        ...
        if (this.props.sessionControl.newSessionUri) {
          ...
          return React.createElement("div", null, "Loading next session...");
        } else {
      ...
      const scores = Object.keys(publishedScores).map(pS => {
        ...
        return React.createElement("div", {
          ...
          id: "indicatorCurrent"
        }, " ", currentCSPretty, " "), " | Page ", this.props.score.pageNum, " of ", this.props.score.pageCount, " | Queued: ", React.createElement("span", {
          id: "indicatorQueued"
        }, " ", nextCSPretty, " "))), React.createElement(Score, {
          key: pS,
          uri: pS,
