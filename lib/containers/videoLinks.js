...
class VideoLinks extends Component {
  ...
  videoPlayer(url) {
    ...
    }, /*#__PURE__*/React.createElement(CustomPlayPause, null))));
  }
    ...
    for (var i = 0; i < links.length; i++) {
      ...
      for (var j = 0; j < targets.length; j++) {
        if (this.isIteration(targets[j])) {
          ...
          var audio = iteration.embodimentLists.MP3 ? this.videoPlayer(iteration.embodimentLists.MP3[0]) : /*#__PURE__*/React.createElement("div", null);
          linkMedia[iterationNo] = /*#__PURE__*/React.createElement("div", {
          ...
          }, iteration["http://www.w3.org/2000/01/rdf-schema#label"], " "), /*#__PURE__*/React.createElement("span", {
            className: "segment",
          ...
          var TM = [/*#__PURE__*/React.createElement("div", {
            className: "motifBlock",
            key: "TMlink",
          ...
          compares.push( /*#__PURE__*/React.createElement("div", {
            className: "motifBlock",
            key: "c-" + LID + "---" + RID
          }, /*#__PURE__*/React.createElement("div", {
            className: "motifName motifNames",
            onClick: this.props.compare.bind(null, LID, RID)
          }, "Compare ", iterationL[prefix.rdfs + "label"], " & ", iterationR[prefix.rdfs + 'label'])));
        }
      }
    }
