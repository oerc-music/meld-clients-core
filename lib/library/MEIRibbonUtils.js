...
export function InstrumentType(proto, name, shortname, section, plural, shortplural) {
  if (proto) {
...
export function drawRibbons(blobs, y, rowHeight, step, classes, mover, mout, i, xoff) {
  ...
  for (var i = 0; i < blobs.length; i++) {
    ribbons.push( /*#__PURE__*/React.createElement("rect", {
      y: y + rowHeight / 8,
  ...
  return /*#__PURE__*/React.createElement("g", null, ribbons);
}
