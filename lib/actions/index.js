...
export function registerTraversal(docUri, suppliedParams = {}) {
  ...
  */
  ...
  const oldParamsMap = (("objectPrefixWhitelist", "expandObjectPrefix"), ("objectUriWhitelist", "expandObjectUri"), ("objectTypeWhitelist", "expandObjectType"), ("objectPrefixBlacklist", "ignoreObjectPrefix"), ("objectUriBlacklist", "ignoreObjectUri"), ("objectTypeBlacklist", "ignoreObjectType"), ("propertyPrefixWhitelist", "followPropertyPrefix"), ("propertyUriWhitelist", "followPropertyUri"), ("propertyPrefixBlacklist", "ignorePpropertyPrefix"), ("propertyUriBlacklist", "ignorePropertyUri"));
  ...
  const unimplementedParams = ("expandObjectType", "ignoreObjectType", "followPropertyPrefix", "followPropertyUri", "ignorePpropertyPrefix", "ignorePropertyUri");
...
function traverseJSONLD(dispatch, docUri, params, dataPromise) {
  console.log("in traverseJSONLDf or doc ", docUri, "with blacklist ", params["ignoreObjectUri"]); // expand the JSON-LD object so that we are working with full URIs, not compacted into prefixes
...
function passesTraversalConstraints(obj, params) {
  ...
  if (params["expandObjectUri"].length) {
    ...
    if (!params["expandObjectUri"].includes(resourceUri) || params["ignoreObjectUri"].includes(resourceUri)) {
