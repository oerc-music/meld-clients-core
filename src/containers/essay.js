...
const FOR_ORCHESTRA =
  "http://id.loc.gov/authorities/performanceMediums/2013015516";
...
function isElementInViewport(el) {
  ...
  return (
    ...
    rect.left >=
      (window.innerWidth || document.documentElement.clientWidth) / 2 - 350 &&
    rect.bottom <=
      (window.innerHeight || document.documentElement.clientHeight) - 190 &&
    rect.right <=
      (window.innerWidth || document.documentElement.clientWidth) / 2 + 350
  );
}
