...
class TimeSensitiveImage extends Component {
  ...
  tick(id, t) {
    ...
    if (
      Math.floor(t.currentTime) > this.state.lastMediaTick ||
  ...
  render() {
    ...
    if (
      ...
      let t =
        this.props.timesync.mediaResources[this.props.clockProvider][
          "currentTime"
        ];
      ...
      t = t + offset;
      const syncs =
        this.props.timesync.mediaResources[this.props.clockProvider]["times"];
