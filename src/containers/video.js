...
class Video extends Component {
  ...
  tick(id, t) {
    if (
      Math.floor(t.currentTime) > this.state.lastMediaTick || // if we've progressed across the next second boundary,
  ...
  render() {
    ...
    var cT =
      ...
      this.props.uri in this.props.timesync.mediaResources
        ? this.props.timesync.mediaResources[this.props.uri]["currentTime"]
        : 0;
    /*
		console.log(this.props.timesync);
